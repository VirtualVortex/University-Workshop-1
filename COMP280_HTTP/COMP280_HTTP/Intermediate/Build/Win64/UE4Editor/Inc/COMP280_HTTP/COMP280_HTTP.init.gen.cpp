...
void EmptyLinkFunctionForGeneratedCodeCOMP280_HTTP_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_COMP280_HTTP()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_COMP280_HTTP_RequestComplete__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_COMP280_HTTP_TimerComplete__DelegateSignature,
			};
